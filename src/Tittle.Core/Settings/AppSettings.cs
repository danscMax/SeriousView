...
public sealed record EditorSettings(double FontSize, bool WordWrap, bool ShowLineNumbers, bool JsonPretty = false, bool CsvAsTable = true, bool SmartTypography = true);

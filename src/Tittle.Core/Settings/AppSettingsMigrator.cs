...
public static class AppSettingsMigrator
{
    ...
    public static AppSettings? Migrate(AppSettings? loaded)
    {
        ...
        // v1 → v2: split-view (M-split) added LayoutSettings.SplitOrientation/SplitRatio. They are
        // non-nullable with defaults, so an old Layout section deserializes to Horizontal/0.5 with no
